 ...
 *  cats.data.EitherT$
 *  cats.mtl.Handle$
 *  cats.mtl.HandleCrossCompat
 *  cats.mtl.HandleCrossCompat$AdHocSyntaxWired
 *  cats.mtl.HandleCrossCompat$AdHocSyntaxWired$Inner
 *  cats.mtl.Raise
...
import cats.mtl.HandleCrossCompat;
...
implements Serializable {
    ...
    public EitherT<Eval, Throwable, String> test() {
        ...
        HandleCrossCompat.AdHocSyntaxWired AdHocSyntaxWired_this = new HandleCrossCompat.AdHocSyntaxWired((HandleCrossCompat)HandleCrossCompat_this);

        MonadError x$2$proxy1 = EitherT$.MODULE$.catsDataMonadErrorForEitherT((Monad)Eval$.MODULE$.catsBimonadForEval());

        return (EitherT)new HandleCrossCompat.AdHocSyntaxWired.Inner(AdHocSyntaxWired_this, (Function1 & Serializable)evidence$1 -> {
