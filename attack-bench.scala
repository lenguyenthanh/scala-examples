...
//
//   @Benchmark
//   def currentInitialize(bh: Blackhole) =
//     bh.consume(Attacks.initialize())
//
//   @Benchmark
//   def initializeWhileLoop(bh: Blackhole) =
//     bh.consume(Attacks.initialize_new())
//
...
object Attacks:
  ...
  //   i = 0
  //   while i < 64 do
  //     KNIGHT_ATTACKS(i) = slidingAttacks(i, all, KNIGHT_DELTAS)
  //     KING_ATTACKS(i) = slidingAttacks(i, all, KING_DELTAS)
  //     WHITE_PAWN_ATTACKS(i) = slidingAttacks(i, all, WHITE_PAWN_DELTAS)
  //     BLACK_PAWN_ATTACKS(i) = slidingAttacks(i, all, BLACK_PAWN_DELTAS)
  ...
  //         RAYS(a)(b) = (1L << a) | (1L << b) | (slidingAttacks(a, 0, ROOK_DELTAS) &
  ...
  //         RAYS(a)(b) = (1L << a) | (1L << b) | (slidingAttacks(a, 0, BISHOP_DELTAS)
