...
*/
    public EitherT<Eval, Throwable, String> test1() {
        ...
        // InnerWired class doesn't exist in runtime yes
        // apply allow body and return InnerWired instance
        EitherT fb$proxy1 = (EitherT)InnerWired$.MODULE$.inline$body$extension((Function1)InnerWired_this).apply((Object)new InnerHandle(Marker, (ApplicativeError)x$2$proxy1));
        // InnerWired$.MODULE$.inline$body$extension = identity
        // InnerWired_this.apply(new InnerHandle(Marker, x$2$proxy1));
        // fb$proxy1 is fb in `inner` function

        // rescure body
        Function1 & Serializable f$proxy2 = (Function1 & Serializable)x$1 -> {
            Error$ error$ = x$1;
        ...
        return (EitherT)package.ApplicativeThrow$.MODULE$.apply((ApplicativeError)x$2$proxy1).handleErrorWith((Object)fb$proxy1, (Function1 & Serializable)x$1 -> {
            ...
            if (throwable instanceof Handle.Submarine) {
                ...
                if (BoxesRunTime.equals((Object)Marker, (Object)object2)) {
                    return (EitherT)f$proxy2.apply((Object)((Error$)e));
                }
            }
