...
implements Serializable {
    ...
    public EitherT<Eval, Throwable, String> test() {
        ...
        return (EitherT)package.ApplicativeThrow$.MODULE$.apply((ApplicativeError)x$2$proxy1).handleErrorWith(InnerWired$.MODULE$.inline$body$extension((Function1)InnerWired_this).apply((Object)new InnerHandle(Marker, (ApplicativeError)x$2$proxy1)), (Function1 & Serializable)x$1 -> {
